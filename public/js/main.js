...
/*------------------------------------------------------------------------------*/
  ...
  $(".header--search").each(function () {
    $(".search_btn", this).on("click", function (e) {
      ...
      $(".header--search_content").toggleClass("on");

      if ($(".header--search a").hasClass("open")) {
        $(".header--search a i").removeClass("ti-close").addClass("ti-search");

        $(this).removeClass("open").addClass("sclose");
      } else {
        $(".header--search a").removeClass("sclose").addClass("open");

        $(".header--search a i").removeClass("ti-search").addClass("ti-close");
      }
    });
  });
  ...
  $(window).on("scroll", function () {
    if (matchMedia("only screen and (min-width: 1200px)").matches) {
      if ($(window).scrollTop() >= 50) {
        $(".ct-stickable-header").addClass("fixed-header");
      } else {
        $(".ct-stickable-header").removeClass("fixed-header");
      }
    }
  });
...
/*------------------------------------------------------------------------------*/
  ...
  $(".ct-tabs > .tabs")
    .children("li")
    .on("click", function (e) {
      var tab = $(this).closest(".ct-tabs > .tabs > .tab"),
        index = $(this).closest(".ct-tabs > .tabs > li").index();
...
/*------------------------------------------------------------------------------*/
  $(function () {
    ...
    jQuery("a.base_prettyphoto").prettyPhoto();
