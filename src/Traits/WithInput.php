...
trait WithInput
{
    ...
    /**
     * Coderstmly the callback if the resource contains the given input item key.
     *
     * @param  string  $key
    ...
    /**
     * Coderstmly the callback if the resource contains a non-empty value for the given input item key.
     *
     * @param  string  $key
     * @param  callable  $callback
     * @param  callable|null  $default
