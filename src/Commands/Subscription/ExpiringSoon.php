...
class ExpiringSoon extends Command
{
    ...
    protected array $intervals = [
        ['days' => 7,  'action' => 'expiring-7-days-notification'],
        ['days' => 2,  'action' => 'expiring-2-days-notification'],
        ['days' => 1,  'action' => 'expiring-1-day-notification'],
    ];
                    ...
                    if ($user = $subscription->user) {
                        if (apply_filters('subscription.expiring_soon.should_send', true, $user, $subscription, $interval['days'])) {
                            ...
                            $subscription->logs()->create([
                                ...
                                'message' => "Notification for subscription expiring in {$interval['days']} day(s) has been successfully sent.",
                            ]);
                        }
                    }
                } catch (\Throwable $e) {
