...
class GroupController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(['data' => $group, 'message' => __('Group has been created successfully!')], 200);
    }
    ...
    public function update(Request $request, Group $group)
    {
        ...
        return response()->json(['data' => $group, 'message' => __('Group has been updated successfully!')], 200);
    }
