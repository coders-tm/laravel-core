...
class NotificationController extends Controller
{
    ...
    {
        $rules = ['label' => 'required|string|max:255', 'type' => 'required|string|max:100', 'content' => 'required|string', 'text' => 'nullable|string', 'subject' => 'nullable|string|max:255', 'is_default' => 'nullable|boolean'];
    ...
    {
        $rules = ['label' => 'sometimes|required|string|max:255', 'type' => 'sometimes|required|string|max:100', 'content' => 'sometimes|required|string', 'text' => 'sometimes|nullable|string', 'subject' => 'sometimes|nullable|string|max:255', 'is_default' => 'sometimes|nullable|boolean'];
        $data = $request->validate($rules);
