...
class SwapSubscriptionPlan
{
    public function execute($subscription, $planId, $billing = 'monthly', bool $invoiceNow = true, bool $force = false)
    {
        ...
        $subscription->fill(['canceled_at' => null, 'billing_interval' => $billingInterval, 'billing_interval_count' => $billingIntervalCount, 'total_cycles' => $newPlan->contract_cycles, 'current_cycle' => 0, 'credit_resets_at' => null])->save();
