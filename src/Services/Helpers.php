...
class Helpers
{
     ...
     *
     * @throws NpmNotFoundException If npm is not installed on the server.
     * @throws NpmNotInstalledException If the npm test command fails to execute successfully.
     */
