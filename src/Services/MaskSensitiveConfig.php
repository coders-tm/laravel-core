        ...
        foreach ($this->dangerousFunctions as $function) {
            if (str_ends_with($function, '::')) {
                ...
                if (preg_match($pattern, $content, $matches)) {
                    throw new \InvalidArgumentException("Function '{$matches[0]}' is not allowed for security reasons.");
                }
            } else {
