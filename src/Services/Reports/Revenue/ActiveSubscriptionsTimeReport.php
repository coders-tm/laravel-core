...
/**
 * Active Subscriptions Over Time Report - Shows subscription count trends.
 */
class ActiveSubscriptionsTimeReport extends AbstractReport
{
    ...
    protected array $columns = [
        ...
        'net_change' => ['label' => 'Net Change', 'type' => 'number'],
    ...
    public function query(array $filters)
    {
        ...
        // Build period boundaries array (label computed in toRow())
        $periodBoundaries = [];
        ...
        // Wrap with window function to calculate growth rate
        return DB::table(DB::raw("({$metricsQuery->toSql()}) as metrics"))
            ->mergeBindings($metricsQuery)
            ->select([
                'metrics.period_start',
                'metrics.period_order',
    ...
    public function toRow($row): array
    {
        ...
        return [
            ...
            'growth_rate' => (float) ($row->growth_rate ?? 0),
        ];
    }
    ...
    public function summarize(array $filters): array
    {
        ...
        return [
            'current_active' => (int) $currentActive,
        ];
    }
}
