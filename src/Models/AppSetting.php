...
class AppSetting extends Model
{
    ...
    static public function getSettings(): array
    {
        ...
        // Handle case where cached data might still be a Collection from previous implementation
        if ($settings instanceof \Illuminate\Support\Collection) {
            Cache::forget(static::$cacheKey); // Clear invalid cache format
            return static::getSettings(); // Try again with fresh data
        }
