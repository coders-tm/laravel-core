...
class Blog extends Model
{
    ...
    protected $fillable = ['title', 'slug', 'description', 'meta_title', 'meta_keywords', 'meta_description', 'is_active', 'options', 'category', 'admin_id'];

    protected $with = ['thumbnail', 'tags', 'admin'];
    ...
    {
        return static::where('slug', $slug)->where('is_active', true)->with(['tags', 'admin'])->firstOrFail();
    }
