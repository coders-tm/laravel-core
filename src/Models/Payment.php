...
class Payment extends Model
{
    ...
    protected $fillable = ['uuid', 'paymentable_type', 'paymentable_id', 'payment_method_id', 'transaction_id', 'amount', 'currency', 'capturable', 'status', 'note', 'metadata', 'fees', 'net_amount', 'processed_at', 'refund_amount'];
