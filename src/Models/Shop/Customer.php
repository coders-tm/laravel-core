...
class Customer extends User
{
    ...
    public function getShortCodes(): array
    {
        return [
            ...
            'email_marketing' => (bool) $this->email_marketing,
            'collect_tax' => (bool) $this->collect_tax,

            // Personal information
            'gender' => $this->gender,
            'dob' => optional($this->dob)->format('M d, Y'),

            // Order statistics
            'total_orders' => $this->total_orders ?? 0,
            'total_spent' => format_amount($this->total_spent ?? 0),
            'average_order_amount' => format_amount($this->average_order_amount ?? 0),
            ...
            'address' => $this->address ? [
                ...
                'full' => $this->address->full_address,
            ] : null,

            // Latest order information
            'latest_order' => $this->latestOrder ? [
                'id' => $this->latestOrder->id,
                'number' => $this->latestOrder->formated_id,
                'total' => format_amount($this->latestOrder->grand_total ?? 0),
                'date' => optional($this->latestOrder->created_at)->format('M d, Y'),
            ] : null,

            // Status flags
            'is_active' => (bool) $this->is_active,
            'member_since' => optional($this->created_at)->format('M Y'),
