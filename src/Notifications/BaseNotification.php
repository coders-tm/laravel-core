...
class BaseNotification extends Notification
{
    ...
    {
        return CloudMessage::fromArray(['notification' => array_filter(['title' => $this->pushSubject, 'body' => $this->pushMessage, 'image' => $this->pushImage]), 'topic' => $this->pushTopic, 'data' => array_map(fn ($v) => (string) $v, array_filter($this->pushData))]);
    }
