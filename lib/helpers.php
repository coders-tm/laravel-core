...
if (! function_exists('guard')) {
    ...
    function guard(...$args)
    {
        ...
        foreach ($args as $guard) {
            if ($guard) {
                if (isset($configGuards[$guard]) && Auth::guard($guard)->check()) {
...
if (! function_exists('user')) {
    function user(array|string|null $key = null, $default = null)
    {
        $user = Auth::user();
...
if (! function_exists('currency_symbol')) {
    ...
    {
        return Currencies::getSymbol($currency ?? config('stripe.currency', 'USD'));
    }
}
...
if (! function_exists('add_filter')) {
    ...
    {
        return app('hooks')->add_filter($tag, $callback, $priority, $accepted_args);
    }
}
...
if (! function_exists('apply_filters')) {
    ...
    {
        return app('hooks')->apply_filters($tag, $value, ...$args);
    }
}
...
if (! function_exists('add_action')) {
    ...
    {
        return app('hooks')->add_action($tag, $callback, $priority, $accepted_args);
    }
}
