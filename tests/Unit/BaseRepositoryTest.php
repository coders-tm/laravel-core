...
class BaseRepositoryTest extends TestCase
{
    ...
    public function it_uses_billing_address_for_tax_calculation()
    {
        ...
        $this->assertInstanceOf(Collection::class, $repo->tax_lines);
    }
    ...
    public function it_normalizes_line_items_correctly()
    {
        ...
        $this->assertInstanceOf(Coderstm::$orderLineItemModel, $items->first());
    ...
    public function it_handles_attribute_setting_via_constructor()
    {
        ...
        $this->assertInstanceOf(Collection::class, $repo->line_items);
        $this->assertInstanceOf(Coderstm::$orderLineItemModel, $repo->line_items->first());
    }
    ...
    public function it_tests_line_items_accessor_get()
    {
        ...
        $this->assertInstanceOf(Coderstm::$orderLineItemModel, $lineItems->first());
    ...
    public function it_tests_line_items_accessor_set()
    {
        ...
        $this->assertInstanceOf(Coderstm::$orderLineItemModel, $firstItem);
    ...
    public function it_tests_set_line_items_method_directly()
    {
        ...
        $this->assertInstanceOf(Coderstm::$orderLineItemModel, $result->first());
