<table cellpadding="0" cellspacing="0" role="presentation" width="100%"><tr><td>
    ...
    <p>Your subscription has ended. You no longer have access to premium features.</p>

    <table cellpadding="0" cellspacing="0" role="presentation" width="100%" style="margin:20px auto;text-align:center;" align="center">
        <tr>
            <td align="center">
                <a href="{{ $billing_page }}" target="_blank" rel="noopener" style="border-radius:4px;color:#ffffff;display:inline-block;text-decoration:none;padding:0 12px;font-size:14px;line-height:28px;font-weight:500;background:#2d3748;">
                    Renew Subscription
                </a>
            </td>
        </tr>
    ...
    <table cellpadding="0" cellspacing="0" role="presentation" width="100%" style="margin:20px 0;">
        <tr>
            <td style="background:#edf2f7;color:#718096;padding:12px;font-size:14px;line-height:1.5;">
                <p style="font-size:12px;line-height:1.5;margin:0;color:#6b7280;">Thank you for being a subscriber.</p>
            </td>
        </tr>
    </table>
</td></tr></table>
