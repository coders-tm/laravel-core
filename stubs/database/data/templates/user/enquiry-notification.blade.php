<table cellpadding="0" cellspacing="0" role="presentation" width="100%"><tr><td>
    ...
    <div style="font-size:14px;line-height:1.6;margin:0 0 16px;">{!! $enquiry->message !!}</div>

    <h3 style="margin:0 0 12px;font-size:14px;font-weight:600;color:#111827;">Ticket Details</h3>
    ...
    <table cellpadding="0" cellspacing="0" role="presentation" width="100%" style="margin:20px auto;text-align:center;" align="center">
        <tr>
            <td align="center">
                <a href="{{ $enquiry->url }}" target="_blank" rel="noopener" style="border-radius:4px;color:#ffffff;display:inline-block;text-decoration:none;padding:0 12px;font-size:14px;line-height:28px;font-weight:500;background:#2d3748;">Reply Now</a>
            </td>
        </tr>
    </table>
    ...
    <table cellpadding="0" cellspacing="0" role="presentation" width="100%" style="margin:20px 0;">
        <tr>
            <td style="background:#edf2f7;color:#718096;padding:12px;font-size:14px;line-height:1.5;">
                <p style="font-size:12px;line-height:1.5;margin:0;color:#6b7280;">Please don't respond to this email; respond via the portal.</p>
            </td>
        </tr>
    </table>
</td></tr></table>
