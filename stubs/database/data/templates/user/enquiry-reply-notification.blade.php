<table cellpadding="0" cellspacing="0" role="presentation" width="100%"><tr><td>
    ...
    <p style="font-size:14px;line-height:1.6;margin:0 0 16px;color:#6b7280;">Respond via the portal for threaded history.</p>
    ...
    <table cellpadding="0" cellspacing="0" role="presentation" width="100%" style="margin:20px 0;">
        <tr>
            <td style="background:#edf2f7;color:#718096;padding:12px;font-size:14px;line-height:1.5;">
                <p style="font-size:12px;line-height:1.5;margin:0;color:#6b7280;">Please don't reply to this email; use the customer portal.</p>
            </td>
        </tr>
    </table>
</td></tr></table>
