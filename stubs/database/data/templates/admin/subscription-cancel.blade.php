<table cellpadding="0" cellspacing="0" role="presentation" width="100%"><tr><td>
    ...
    <h3 style="margin:0 0 12px;font-size:14px;font-weight:600;color:#111827;">Subscription Summary</h3>
    <table cellpadding="0" cellspacing="0" role="presentation" width="100%" style="background:#f9fafb;border:1px solid #e5e7eb;margin-bottom:16px;font-size:14px;">
        ...
        <tr><td width="35%" style="padding:12px;font-size:12px;font-weight:600;color:#6b7280;vertical-align:middle;">Ends At</td><td style="padding:12px;font-size:14px;color:#111827;vertical-align:middle;">{{ $expires_at ?: $ends_at }}</td></tr>
    </table>

    <p style="font-size:14px;line-height:1.6;margin:0 0 16px;color:#6b7280;">Please update internal records. If the member returns, ensure a smooth reactivation experience.</p>
    ...
    <table cellpadding="0" cellspacing="0" role="presentation" width="100%" style="margin:20px 0;">
        <tr>
            <td style="background:#edf2f7;color:#718096;padding:12px;font-size:14px;line-height:1.5;">
                <p style="font-size:12px;line-height:1.5;margin:0;color:#6b7280;">Cancellation date reflects the recorded subscription end. If this was accidental, initiate a manual reactivation.</p>
            </td>
        </tr>
    </table>
</td></tr></table>
