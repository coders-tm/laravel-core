<div>
    ...
    <table cellpadding="0" cellspacing="0" role="presentation" width="100%" class="action" align="center">
        <tr>
            <td align="center">
                <a href="{{ $enquiry->admin_url }}" target="_blank" rel="noopener" class="btn btn-dark">Reply Now</a>
            </td>
        </tr>
    </table>
    ...
    <table cellpadding="0" cellspacing="0" role="presentation" width="100%" class="subcopy"
        ...
        <tr>
            <td>
                <p class="text-muted">
                    If you're having trouble clicking the "Reply Now" button, copy and paste the URL below into your
                    web browser:
