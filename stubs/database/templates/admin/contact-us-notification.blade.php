<div>
    ...
    <p>We have received a new submission through the contact form. Here are the details:</p>

    <p class="section-title" style="margin-top:0">Submission Details</p>
    <table class="card-table" cellpadding="0" cellspacing="0" role="presentation">
        <tbody>
            <tr>
                <td class="label">Name</td>
                <td class="value">{{ $user->name ?? 'Guest' }}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="value">{!! $enquiry->message ?? '' !!}</td>
            </tr>
        </tbody>
    </table>
    ...
    <table cellpadding="0" cellspacing="0" role="presentation" width="100%" class="action" align="center">
        <tr>
            <td align="center">
                <a href="{{ $enquiry->admin_url }}" target="_blank" rel="noopener" class="btn btn-dark">View Submission</a>
            </td>
        </tr>
    </table>
    ...
    <table cellpadding="0" cellspacing="0" role="presentation" width="100%" class="subcopy"
        ...
        <tr>
            <td>
                <p class="text-muted">
                    If you're having trouble clicking the "View Submission" button, copy and paste the URL below into
                    your
                    web browser:
    ...
    <table cellpadding="0" cellspacing="0" role="presentation" width="100%" class="panel panel-neutral">
        <tr>
            <td class="panel-content">
                <p class="small-note">This email was sent through the general contact form.</p>
            </td>
        </tr>
    </table>
</div>
